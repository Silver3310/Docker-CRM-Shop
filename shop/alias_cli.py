...
def migrate():
    # migrate  migrations
    call('docker-compose run --rm web python shop/manage.py migrate'.split())
...
def create_super_user():
    # create super user
    call('docker-compose run --rm web python shop/manage.py createsuperuser'.split())
...
def remove_migrations():
    # remove migrations
    call('docker-compose run --rm web find . -path "./shop/*/migrations/*.py" -not -name "__init__.py" -delete'.split())


def change_admin_password():
    # change admin password
    call('docker-compose run --rm web python shop/manage.py changepassword admin'.split())


def shell_plus():
    # shell plus
    call('docker-compose run --rm web python shop/manage.py shell_plus'.split())
...
def show_help():
    ...
    print(
        ...
        python alias_cli.py all - run commands in the following order: build, migrate, makemigrations, migrate, loaddata, createsuperuser, runserver.\n 
